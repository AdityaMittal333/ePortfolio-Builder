...
export default function EditExperienceForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      navigate(`/${ownerId}/experience/${id}`);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-100 to-purple-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl bg-white shadow-xl rounded-2xl">
        <CardContent className="p-6 space-y-6">
          <h2 className="text-2xl font-bold text-center text-blue-600">Edit Experince</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="name">Experince Name</Label>
            ...
            <div>
              <Label htmlFor="image">Update Experience Image</Label>
